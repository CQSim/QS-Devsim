...
The second one is a ferroelectric capacitor with a step-like shape. This work is based on the Miller experimental equations [J. Appl. Phys. 1990, 68, 6463] or Laundao-Ginsberg. Users can apply this model from 1D to 3D devices.

The third one is a P-type ferroelectric thin film transistor with bottom-gate and bottom-contact configuration. The ferroelectric model used in this work is same as the second work. This work has been published in Physica Status Solidi (a) 2021, 218 (22).
