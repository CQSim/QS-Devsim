...
The second one is a ferroelectric capacitor with a step-like shape. This work is based on the Miller experimental equations [J. Appl. Phys. 1990, 68, 6463] or Ginzburg-Landau. Users can apply this model from 1D to 3D devices.
